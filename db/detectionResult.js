...
const detectionResultSchema = new mongoose.Schema({
    ...
    flagReason: String, // Reason for flagging (e.g., "Score exceeded threshold", "Multiple modifications detected")
    confidenceLevel: { 
        type: String, 
        enum: ['low', 'medium', 'high'], 
        default: 'low' 
    },
    thresholdExceeded: { type: Boolean, default: false }, // Whether score exceeded the threshold
